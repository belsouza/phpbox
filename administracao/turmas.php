<?php
    include_once "controller/ctrl_turmas.php";
?>
                ...
                <section class="formulario">
                    ...
                    <h1><?php echo $confirma;  ?> Alunos</h1>
                        ...
                        <form method="post" name="formulario1" class="cadform">
                            ...
                            <div>
                                <label>CPF</label>
                                <input type="text" name="cpf" placeholder="CPF" value= "<?php echo $consulta_cpf; ?>">                    
                            </div>

                            <div>
                                <label>Data de Nascimento </label>
                                <input type="date" name="datanascimento" placeholder="Data de Nascimento" value= "<?php echo $consulta_datanascimento; ?>" >                    
                            </div>
