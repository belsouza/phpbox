<?php
    ...
    if($_SERVER["REQUEST_METHOD"] === 'POST'){
        ...
        if(isset($_POST["inserir"])){
            ...
            $mensagem = $disciplinas->inserir_aluno( $nome, $cpf, $datanascimento ); 
        }        
    ...
    if(isset($_GET["editar"]) or isset($_GET["excluir"])  ){
        ...
        if(isset($_GET["editar"])){
            ...
            $consulta_nome = $disciplinas->exibir_nome( $consulta_matricula );
            $consulta_cpf = $disciplinas->exibir_cpf( $consulta_matricula );
            $consulta_datanascimento = $disciplinas->exibir_datanascimento(  $consulta_matricula );
            $consultatabela = "";
            $confirma = "Atualizar";
            $editar = TRUE;
        }
        ...
        if(isset($_POST["operacao"])){
            ...
            if($_POST["operacao"] == "Atualizar"){
                ...
                $mensagem = $disciplinas->atualizar_aluno( $matricula, $nome, $cpf, $datanascimento );
            ...
            if($_POST["operacao"] == "Excluir"){
                ...
                $mensagem = $disciplinas->excluir_aluno( $matricula );
                $consulta_matricula = $consulta_nome = $consulta_cpf = $consulta_datanascimento = $consultatabela = "";                 
                $editar = FALSE; 
            }
        }
    ...
    {
        $consultatabela = $disciplinas->procurar($_GET["procurando"]);
        $tabela = new Tabela( $consultatabela );
        $consulta = $tabela->exibir();
    }
    else{
        $consultatabela = $disciplinas->exibir_disciplinas();
        $tabela = new Tabela( $consultatabela );
        $consulta = $tabela->exibir();
    }
?>